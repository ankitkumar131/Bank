          ...
          <div className="flex items-center flex-shrink-0">
            <Link href="/" className="flex items-center gap-3 group">
              ...
              <div className="hidden sm:flex flex-col">
                <span className="text-lg lg:text-xl font-bold text-charcoal-900 tracking-tight leading-tight group-hover:text-burgundy-700 transition-colors">
                  PARRA VERLA CANCA
                </span>
                <span className="text-xs lg:text-sm font-medium text-charcoal-600 leading-tight">
                  M.P.A.C.S. Ltd.
                </span>
              </div>
            </Link>
